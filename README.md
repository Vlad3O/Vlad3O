...
- 🔭 **Сейчас я работаю над:** Оптимизацией пайплайнов для микросервисной архитектуры.
...
- 📫 **Как со мной связаться:** Через [Telegram](https://t.me/Vls221cs) или по [почте](mailto:movajacks@gmail.com).
- 😄 **Факт обо мне:** Люблю автоматизировать не только рабочие процессы, но и домашнюю рутину.
